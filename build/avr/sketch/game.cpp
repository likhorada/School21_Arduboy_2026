#line 1 "/home/Hermip/Documents/study/School 21/School21_Arduboy_2026/src/game.cpp"
#include "game.h"
...
void updateGame(Game& game, const InputFrame& input) {
    ...
    // Меню отдыха после прохождения стейджа: мир замирает, можно продолжать.
    ...
    // Все волны стейджа пройдены: замираем и показываем экран отдыха.
    if (game.combat.stageCleared) {
        game.state = GameState::StageCleared;
    }
}
